...
/**
 * Modelo que representa um tipo de contato (ex.: telefone, e-mail, etc.).
 *
 * @package App\Models
 * @property int $id
 * @property string $descricao Descrição do tipo de contato
 * @property bool $ativo Indica se o tipo de contato está ativo
