...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/pessoa/inserir', 'App\Http\Controllers\PessoaController@store')->name('pessoa.salvar');
    Route::get('/pessoa/editar/{pessoa}', 'App\Http\Controllers\PessoaController@edit')->name('pessoa.editar');
    Route::put('/pessoa/editar/{pessoa}', 'App\Http\Controllers\PessoaController@update')->name('pessoa.atualizar');
    ...
    Route::post('/tipo-contato/inserir', 'App\Http\Controllers\TipoContatoController@store')->name('tipo-contato.salvar');
    Route::get('/tipo-contato/editar/{tipoContato}', 'App\Http\Controllers\TipoContatoController@edit')->name('tipo-contato.editar');
    Route::put('/tipo-contato/editar/{tipoContato}', 'App\Http\Controllers\TipoContatoController@update')->name('tipo-contato.atualizar');
    ...
    Route::post('/funcionario/inserir', 'App\Http\Controllers\FuncionarioController@store')->name('funcionario.salvar');
    Route::get('/funcionario/editar/{funcionario}', 'App\Http\Controllers\FuncionarioController@edit')->name('funcionario.editar');
    Route::put('/funcionario/editar/{funcionario}', 'App\Http\Controllers\FuncionarioController@update')->name('funcionario.atualizar');
    ...
    Route::post('/cliente/inserir', 'App\Http\Controllers\ClienteController@store')->name('cliente.salvar');
    Route::get('/cliente/editar/{cliente}', 'App\Http\Controllers\ClienteController@edit')->name('cliente.editar');
    Route::put('/cliente/editar/{cliente}', 'App\Http\Controllers\ClienteController@update')->name('cliente.atualizar');
    ...
    Route::post('/fornecedor/inserir', 'App\Http\Controllers\FornecedorController@store')->name('fornecedor.salvar');
    Route::get('/fornecedor/editar/{fornecedor}', 'App\Http\Controllers\FornecedorController@edit')->name('fornecedor.editar');
    Route::put('/fornecedor/editar/{fornecedor}', 'App\Http\Controllers\FornecedorController@update')->name('fornecedor.atualizar');
    ...
    Route::post('/materia-prima/inserir', 'App\Http\Controllers\MateriaPrimaController@store')->name('materia-prima.salvar');
    Route::get('/materia-prima/editar/{materiaPrima}', 'App\Http\Controllers\MateriaPrimaController@edit')->name('materia-prima.editar');
    Route::put('/materia-prima/editar/{materiaPrima}', 'App\Http\Controllers\MateriaPrimaController@update')->name('materia-prima.atualizar');
    ...
    Route::post('/tipo-materia-prima/inserir', 'App\Http\Controllers\TipoMateriaPrimaController@store')->name('tipo-materia-prima.salvar');
    ...
    Route::put('/tipo-materia-prima/editar/{tipoMateriaPrima}', 'App\Http\Controllers\TipoMateriaPrimaController@update')->name('tipo-materia-prima.atualizar');
    ...
    Route::post('/equipamento-operacional/inserir', 'App\Http\Controllers\EquipamentoOperacionalController@store')->name('equipamento-operacional.salvar');
    ...
    Route::put('/equipamento-operacional/editar/{equipamentoOperacional}', 'App\Http\Controllers\EquipamentoOperacionalController@update')->name('equipamento-operacional.atualizar');
    ...
    Route::post('/servico/inserir', 'App\Http\Controllers\ServicoController@store')->name('servico.salvar');
    Route::get('/servico/editar/{servico}', 'App\Http\Controllers\ServicoController@edit')->name('servico.editar');
    Route::put('/servico/editar/{servico}', 'App\Http\Controllers\ServicoController@update')->name('servico.atualizar');
    ...
    Route::post('/componente-servico/inserir', 'App\Http\Controllers\ComponenteServicoController@store')->name('componente-servico.salvar');
    ...
    Route::put('/componente-servico/editar/{componenteServico}', 'App\Http\Controllers\ComponenteServicoController@update')->name('componente-servico.atualizar');
    ...
    Route::post('/orcamento/inserir', 'App\Http\Controllers\OrcamentoController@store')->name('orcamento.salvar');
    ...
    Route::put('/orcamento/editar/{orcamento}', 'App\Http\Controllers\OrcamentoController@update')->name('orcamento.atualizar');
    ...
    Route::post('/ordem-servico/inserir', 'App\Http\Controllers\OrdemServicoController@store')->name('ordem-servico.salvar');
    ...
    Route::put('/ordem-servico/editar/{ordemServico}', 'App\Http\Controllers\OrdemServicoController@update')->name('ordem-servico.atualizar');
    ...
    Route::post('/ordem-compra/inserir', 'App\Http\Controllers\OrdemCompraController@store')->name('ordem-compra.salvar');
    Route::get('/ordem-compra/editar/{oc}', 'App\Http\Controllers\OrdemCompraController@edit')->name('ordem-compra.editar');
    Route::put('/ordem-compra/editar/{oc}', 'App\Http\Controllers\OrdemCompraController@update')->name('ordem-compra.atualizar');
    ...
    Route::post('/perda-quebra/inserir', 'App\Http\Controllers\PerdasQuebrasController@store')->name('perda-quebra.salvar');
    Route::get('/perda-quebra/editar/{perdaQuebra}', 'App\Http\Controllers\PerdasQuebrasController@edit')->name('perda-quebra.editar');
    Route::put('/perda-quebra/editar/{perdaQuebra}', 'App\Http\Controllers\PerdasQuebrasController@update')->name('perda-quebra.atualizar');
    ...
    Route::post('/fatura/inserir', 'App\Http\Controllers\FaturaController@store')->name('fatura.salvar');
    Route::get('/fatura/editar/{fatura}', 'App\Http\Controllers\FaturaController@edit')->name('fatura.editar');
    Route::put('/fatura/editar/{fatura}', 'App\Http\Controllers\FaturaController@update')->name('fatura.atualizar');
    ...
    Route::post('/boleto/inserir', 'App\Http\Controllers\BoletoController@store')->name('boleto.salvar');
    Route::get('/boleto/editar/{boleto}', 'App\Http\Controllers\BoletoController@edit')->name('boleto.editar');
    Route::put('/boleto/editar/{boleto}', 'App\Http\Controllers\BoletoController@update')->name('boleto.atualizar');
